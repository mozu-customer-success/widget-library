...
define([
  ...
  function factory(conf) {
    ...
    function updateUi(response) {
      ...
      if (window.hooks && window.hooks.productListBefore)
        response.body = window.hooks.productListBefore(response.body);
      _$body.html(response.body);
      if (window.hooks && window.hooks.productListAfter)
        response.body = window.hooks.productListAfter(document);
